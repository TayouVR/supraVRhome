            ...
            if (mode >= WaterMode.Reflective)
            {
                if (cam.stereoEnabled)
                {
                    if (cam.stereoTargetEye == StereoTargetEyeMask.Both || cam.stereoTargetEye == StereoTargetEyeMask.Left)
                    {
                        ...
                        _renderer.sharedMaterial.SetTexture("_ReflectionTex0", m_ReflectionTexture0);
                    }
                    ...
                    if (cam.stereoTargetEye == StereoTargetEyeMask.Both || cam.stereoTargetEye == StereoTargetEyeMask.Right)
                    {
                        ...
                        _renderer.sharedMaterial.SetTexture("_ReflectionTex1", m_ReflectionTexture1);
                    }
                }
                else
                {
            ...
            if (mode >= WaterMode.Refractive)
            {
                if (cam.stereoEnabled) {
                    if (cam.stereoTargetEye == StereoTargetEyeMask.Both || cam.stereoTargetEye == StereoTargetEyeMask.Left) {
                        ...
                        _renderer.sharedMaterial.SetTexture("_RefractionTex0", m_RefractionTexture0);
                    }
                    ...
                    if (cam.stereoTargetEye == StereoTargetEyeMask.Both || cam.stereoTargetEye == StereoTargetEyeMask.Right) {
                        ...
                        refractionCamera.Render();
                        _renderer.sharedMaterial.SetTexture("_RefractionTex1", m_RefractionTexture1);
                    }
                } else {
                    refractionCamera.worldToCameraMatrix = cam.worldToCameraMatrix;
